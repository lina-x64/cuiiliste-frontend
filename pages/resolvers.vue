...
async function getResolverStatus() {
	...
	return resolvers.filter((resolver: any) => resolver.obeys_cuii).sort((a: any, b: any) => a.resolver.localeCompare(b.resolver))
}
getResolverStatus().then((res) => {
	blockingResolvers.value = res
...
<template>
	<div class="flex flex-col items-start">
		...
		<p class="2xl:w-3/5">
			...
			<br>
			Lustige Info nebenbei: Vodafone, 1&1 und Telefónica (aka o2) erlauben leider keinen Zugriff von außen auf ihre DNS-Resolver.
			...
			Diesen DNS-Resolvern haben wir eher wenig bedeutende Namen gegeben. Die von der Telekom wurden von dieser selbst benannt.
		</p>
